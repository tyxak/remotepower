...
function _renderKevFeedStatus(f) {
  ...
  el.textContent = `KEV feed: ${f.kev_count.toLocaleString(_localeTag())} known-exploited CVEs loaded (updated ${when}). A 0 here means none of that host's CVEs are on CISA's KEV list.`;
}
