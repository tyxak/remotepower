...
CADENCE = (
    ...
    'run_thermal_rollup_if_due',         # v6.4.2 long-range thermal roll-ups
    ...
    'run_sidecar_watch_if_due',
    'run_mitigate_verify_if_due',
    # v6.4.2: _record_self_alive is NOT a cadence sweep. Its hourly
