...
- For AI clients, **MCP** exposes multi-line *saved scripts* (the
  [Scripts](scripts.md) feature) through the `run_saved_script` tool — the
  one-liner library itself is a UI pick-list only.
