...
checkout, pacman/AUR, or apt), pulls the new version, and restarts the app
server (gunicorn). Because the API runs unprivileged, the script re-execs itself under
