...
**v5.2.0**, covered the new WG Access (WireGuard VPN) feature and a whole-project
server + agent security review with SAST tooling (CodeQL, Bandit, gitleaks — all
clean) plus a live authenticated penetration test of the production deployment,
held to the bar — **no Critical, High, or Medium finding ships** — see
[security-review-5.2.0.md](security-review-5.2.0.md). It builds on **v5.1.1**
(see [security-review-5.1.1.md](security-review-5.1.1.md)) and **v5.1.0**
(see [security-review-5.1.0.md](security-review-5.1.0.md)), which underwent the
...
[`security-review-*.md`](security-review-5.2.0.md) files.
...
summarised in the latest, [security-review-5.2.0.md](security-review-5.2.0.md).
...
- **Manual security reviews** of the server and agent every few releases
  ...
  [security-review-5.2.0.md](security-review-5.2.0.md)).
