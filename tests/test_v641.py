...
class TestVersionBumps(unittest.TestCase):
    ...
    def test_readme_recent_releases_capped_at_five(self):
        ...
        self.assertTrue(bullets and bullets[0].endswith(V))
    ...
    def test_whats_new_card_present_and_capped(self):
        ...
        # the sneaky non-visible surface: the doc-search keyword attribute
