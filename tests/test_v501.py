"""Strict version-surface pins for v5.0.1 "TemperMatters" — loosen to regex on the
next bump (see tests/test_v500.py for the loosened pattern). The v5.0.1 feature
tests live in tests/test_v501_features.py.
"""
...
_spec = importlib.util.spec_from_file_location("api_v501_ver", _CGI / "api.py")
...
class TestVersionBumps(unittest.TestCase):
    ...
    def test_no_stale_cachebust(self):
        ...
        self.assertEqual(set(re.findall(r"\?v=(5\.0\.0[^\"&]*)", html)), set(),
                         "stale ?v=5.0.0 cache-busts left")
    ...
    def test_old_version_doc_pruned(self):
        self.assertFalse((_ROOT / "docs/v4.7.0.md").exists(),
                         "docs/v4.7.0.md should be pruned to keep last 5")
    ...
    def test_codename(self):
        self.assertIn("TemperMatters", (_ROOT / "docs" / "v5.0.1.md").read_text())
