"""Version-surface CONSISTENCY checks — loosened from the original strict v5.0.1
pins on the v5.1.0 bump (the strict pins now live in tests/test_v510.py; see
tests/test_v500.py for the same loosened pattern). These track the CURRENT
version across every file that must agree.
"""
