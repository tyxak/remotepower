...
class TestSCGIParsing(unittest.TestCase):
    ...
    def test_parse_headers(self):
        env = api_worker.parse_scgi_headers(
            b'REQUEST_METHOD\x00GET\x00PATH_INFO\x00/api/home\x00')
...
class TestWorkerEndToEnd(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        env = dict(os.environ,
                   RP_DATA_DIR=cls.data_dir,
                   RP_SCGI_SOCKET=cls.sock_path,
                   RP_WORKER_MAX='4')
    ...
    def test_post_body_reaches_handler(self):
        ...
        resp = self._request('POST', '/api/login', body=body,
