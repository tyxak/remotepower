"""Version-surface CONSISTENCY checks — loosened from the original strict v5.0.0
pins on the v5.0.1 bump (the strict pins now live in tests/test_v501.py; see
tests/test_v4100.py for the same loosened pattern). These track the CURRENT
