...
class TestApiWiring(unittest.TestCase):
    def test_sources_wired_in_orchestrator(self):
        for fn in ("build_firewall_corpus", "build_integrations_corpus",
                   ...
                   "build_scap_corpus", "build_security_findings_corpus", "build_hardware_corpus", "build_billing_corpus", "build_remediations_corpus", "build_config_revisions_corpus", "build_sudo_corpus", "build_self_obs_corpus", "build_inventory_corpus",
