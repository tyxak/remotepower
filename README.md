...
[![Version](https://img.shields.io/badge/version-4.4.0-blue.svg)](https://github.com/tyxak/remotepower/releases)
...
**[docs/security-review-4.4.0.md](docs/security-review-4.4.0.md)** (a full
server + agent audit, independently pentested clean), preceded by the 4.3.0 and
4.2.0 reviews. It is
