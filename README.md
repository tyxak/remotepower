...
[![Version](https://img.shields.io/badge/version-4.4.1-blue.svg)](https://github.com/tyxak/remotepower/releases)
...
> travel in cleartext over plain HTTP. The fastest path:
> `sudo apt install certbot python3-certbot-nginx && sudo certbot --nginx -d your.domain.com`
> — full guide in **[docs/install.md → TLS section](docs/install.md)**.
