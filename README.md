...
- **Coming next — 5ecur1tyM4tter5** *(v4.2)* — the next release focuses on **security and integrations**: deeper hardening and tighter connections to the tools you already run.
...
**[docs/security-review-4.1.0.md](docs/security-review-4.1.0.md)** (server +
